...
- [ ] **der Dank** → — (no plural)
- [ ] **der Durst** → — (no plural)
- [ ] **das Fieber** → — (no plural)
- [ ] **das Fleisch** → — (no plural)
- [ ] **die Freizeit** → — (no plural)
- [ ] **das Gemüse** → — (no plural)
- [ ] **das Gepäck** → — (no plural)
- [ ] **das Glück** → — (no plural)
- [ ] **die Halbpension** → — (no plural)
- [ ] **die Heimat** → — (no plural)
- [ ] **der Hunger** → — (no plural)
- [ ] **das Internet** → — (no plural)
- [ ] **die Kleidung** → — (no plural)
- [ ] **die Milch** → — (no plural)
- [ ] **die Mitte** → — (no plural)
- [ ] **das Obst** → — (no plural)
- [ ] **die Polizei** → — (no plural)
- [ ] **die Post** → — (no plural)
- [ ] **der Regen** → — (no plural)
- [ ] **der Reis** → — (no plural)
- [ ] **der Sport** → — (no plural)
- [ ] **der Unterricht** → — (no plural)
- [ ] **der Urlaub** → — (no plural)
- [ ] **die Vorsicht** → — (no plural)
- [ ] **das Wasser** → — (no plural)
- [ ] **das Wetter** → — (no plural)
